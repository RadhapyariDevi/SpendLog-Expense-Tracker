...
import { Currency, CurrencyIcon, DollarSign, LayoutGrid, PiggyBank, ReceiptText, Settings, ShieldCheck,  } from 'lucide-react'
            ...
            {menuList.map((menu,index) => (
                ...
                <h2 className ={`flex gap-2 items-center
                 ...
                 hover:text-secondary-foreground hover:bg-secondary
                    ${path === menu.path ? 'bg-secondary text-secondary-foreground':''}
                 `}>
                    <menu.icon/>
                    {menu.name}
                </h2>
